...
calib_file='/home/cqjtu/Documents/catktin_ros/src/cfg/lidar_camera_calibration63.yaml'
adjust_x=0
...
def ObjectInImage(image,pc_list):
    ...
    for point in coords:
        ...
        if 0<=x<=cols and 0<=y<=rows:
            ...
            get_point=False
    if len(coords)>0:
        print(f'"obj front of camera. coords:{len(coords)}')
